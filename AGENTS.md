...
This file is the quick-reference operating contract for uuid-kotlin. The longer
...
uuid-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`uuid`](https://crates.io/crates/uuid). Upstream Rust is the behavioral oracle while the
